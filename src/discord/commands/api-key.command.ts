...
export class ApiKeyCommand {
  public static readonly data = new SlashCommandBuilder()
    .setName('api-key')
    .setDescription('Manage your Gemini API key for unlimited /banana image generation')
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName('connect')
        .setDescription('Generate a link to connect your Gemini API key'),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName('disconnect')
  ...
  private async handleStatus(
    ...
    if (status.hasKey) {
      embed
        ...
        .setDescription('Your Gemini API key is connected.')
        .addFields(
      ...
      embed
        ...
        .addFields({
          name: 'How to connect',
          value: 'Use `/api-key connect` to bind your Gemini API key and unlock unlimited image generation.',
        });
    }
  ...
  private async handleConnect(
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription('Click the link below to connect your Gemini API key.')
      .addFields(
        {
          name: 'Connection URL',
  ...
  private async handleDisconnect(
    ...
    if (removed) {
      const embed = new EmbedBuilder()
        ...
        .setDescription('Your Gemini API key has been removed.')
        .addFields({
          name: 'What now?',
